...
#define FailTest {if (test_has_passed == true) PrintResultFollower(false, __LINE__); test_has_passed = false;}
...
MyTestApp : public wxAppConsole
{
	...
	public:
		...
		void PrintResultFollower( bool passed, int line);
...
void MyTestApp::PrintResultFollower(bool passed, int line)
{
