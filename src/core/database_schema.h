...
namespace database_schema {
    ...
    std::vector<TableData> static_tables{
        {"MASTER_SETTINGS", "pttirit", {"NUMBER", "PROJECT_DIRECTORY", "PROJECT_NAME", "CURRENT_VERSION", "TOTAL_CPU_HOURS", "TOTAL_JOBS_RUN", "CISTEM_VERSION_TEXT"}},
        ...
        {"IMAGE_ASSETS", "pttiiiiiirrriiiiiiii", {"IMAGE_ASSET_ID", "NAME", "FILENAME", "POSITION_IN_STACK", "PARENT_MOVIE_ID", "ALIGNMENT_ID", "CTF_ESTIMATION_ID", "X_SIZE", "Y_SIZE", "PIXEL_SIZE", "VOLTAGE", "SPHERICAL_ABERRATION","PROTEIN_IS_WHITE","ORIGINAL_X_SIZE","ORIGINAL_Y_SIZE","CROP_CENTER_X","CROP_CENTER_Y"}},
        {"MOVIE_GROUP_LIST", "pti", {"GROUP_ID", "GROUP_NAME", "LIST_ID"}},
        {"MOVIE_ALIGNMENT_LIST", "piiitrrrrrriiriiiiiiiiiiii", {"ALIGNMENT_ID", "DATETIME_OF_RUN", "ALIGNMENT_JOB_ID", "MOVIE_ASSET_ID", "OUTPUT_FILE", "VOLTAGE", "PIXEL_SIZE", "EXPOSURE_PER_FRAME", "PRE_EXPOSURE_AMOUNT", "MIN_SHIFT", "MAX_SHIFT", "SHOULD_DOSE_FILTER", "SHOULD_RESTORE_POWER", "TERMINATION_THRESHOLD", "MAX_ITERATIONS", "BFACTOR", "SHOULD_MASK_CENTRAL_CROSS", "HORIZONTAL_MASK", "VERTICAL_MASK", "SHOULD_INCLUDE_ALL_FRAMES_IN_SUM", "FIRST_FRAME_TO_SUM", "LAST_FRAME_TO_SUM","ORIGINAL_X_SIZE","ORIGINAL_Y_SIZE","CROP_CENTER_X","CROP_CENTER_Y"}},
    ...
    std::vector<TableData> dynamic_tables{
        ...
        {"REFINEMENT_DETAILS_", "plrrrrrrirrrrirrrrirrrrlliiilrrir", {"CLASS_NUMBER", "REFERENCE_VOLUME_ASSET_ID", "LOW_RESOLUTION_LIMIT","HIGH_RESOLUTION_LIMIT", "MASK_RADIUS", "SIGNED_CC_RESOLUTION_LIMIT",
