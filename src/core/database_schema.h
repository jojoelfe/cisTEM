...
namespace database_schema {
    ...
    std::vector<TableData> static_tables{
        ...
        {"IMAGE_ASSETS", "pttiiiiiirrriiiii", {"IMAGE_ASSET_ID", "NAME", "FILENAME", "POSITION_IN_STACK", "PARENT_MOVIE_ID", "ALIGNMENT_ID", "CTF_ESTIMATION_ID", "X_SIZE", "Y_SIZE", "PIXEL_SIZE", "VOLTAGE", "SPHERICAL_ABERRATION","PROTEIN_IS_WHITE","ORIGINAL_X_SIZE","ORIGINAL_Y_SIZE","CROP_CENTER_X","CROP_CENTER_Y"}},
