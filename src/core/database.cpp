...
{
	BeginBatchInsert("IMAGE_ASSETS", 13, "IMAGE_ASSET_ID", "NAME", "FILENAME", "POSITION_IN_STACK", "PARENT_MOVIE_ID", "ALIGNMENT_ID", "CTF_ESTIMATION_ID", "X_SIZE", "Y_SIZE", "PIXEL_SIZE", "VOLTAGE", "SPHERICAL_ABERRATION", "PROTEIN_IS_WHITE","ORIGINAL_X_SIZE","ORIGINAL_Y_SIZE","CROP_CENTER_X","CROP_CENTER_Y");
}
...
{
	AddToBatchInsert("ittiiiiiirrri", image_asset_id, name.ToUTF8().data(), filename.ToUTF8().data(), position_in_stack, parent_movie_id, alignment_id, ctf_estimation_id, x_size, y_size, pixel_size, voltage, spherical_aberration, protein_is_white, original_x_size, original_y_size, crop_center_x, crop_center_y);
}
